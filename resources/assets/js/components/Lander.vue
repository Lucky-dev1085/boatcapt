<template>
    <section class="section-background section-lander mt-0 text-center">
        ...
        <h1 class="page-title">Our Captain, Your Boat!</h1>
        ...
        <article class="article-modal">
            ...
            <h5 class="article-subtitle">Whether it's a sunset cocktail cruise, fishing, transport, or just becoming familiar with your local waters we’re here to help. You pick the trip and that date, we’ll instantly match you with <a href="find-captains">local Captains</a> who can make a trip on your boat a much more enjoyable one!</h5>
            <div class="row mb-3">
                ...
                <div class="col-sm-4 article-item">
                    ...
                    <h4 class="font-twcenmt">Licensed Captains</h4>
                </div>
                <div class="col-sm-4 article-item">
                    <div>
        ...
        <article class="article-modal">
            ...
            <h5 class="article-subtitle">Here are some Captains in your area. Click on any of them to see their experience and request a booking!</h5>
            <div class="row">
            ...
            <br/>
            <div class="text-center">
                <a :href="URL.base + '/captain/register'" class="btn btn-darkblue btn-size-360">Captains Sign Up Here!</a>
            </div>
        </article>
    ...
    export default {
        ...
        created() {
            ...
            window.onscroll = function() {
                ...
                var threshold=$(".section-lander .page-title").outerHeight()+rem*8.275-$(".fixed-top:first").outerHeight();
