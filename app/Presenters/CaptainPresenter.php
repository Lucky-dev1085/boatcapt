...
class CaptainPresenter extends Presenter {
	...
	public function transform($user)
    {
        return [
            ...
            'powerBoats'        => isset($user->captainInfo->powerBoats) ? $user->captainInfo->powerBoats : null,
            'sailBoats'         => isset($user->captainInfo->sailBoats) ? $user->captainInfo->sailBoats : null,
            'resumeFile'        => isset($user->captainInfo->resumeFile) ? $user->captainInfo->resumeFile : null,
