        ...
        <article class="article-page container-768">
            ...
            <form class="form-md" :action="URL.base + '/create-bid'" method="POST">
                ...
                <div class="form-group mt-3" v-show="chargeType == 2">
                    <input name="hours" v-model="hours" type="number" class="form-control" required="required" placeholder="Enter hours..." min="0" />
                </div>
                <h4 class="font-weight-bold mx-4 mt-5">How much will you charge/per hour?</h4>
                <div class="form-group mt-3">
                    <input name="amount" v-model="amount" type="number" step="0.01" class="form-control" required="required" placeholder="Enter amount..." min="0" />
                </div>
