        ...
        <article class="article-page container-768">
            ...
            <form class="form-md container-440" :action="URL.base + '/admin-captain-profile'" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group-location">
                            <input id="fullAddress" name="fullAddress" type="text" class="form-control" placeholder="Full Address..." />
                ...
                <div class="h22 text-center mt-2" v-if="userInfo.resumeFile">
                    <a class="link-underline" :href="URL.base + '/' + profile.id + '/admin-resume-download'">Review Resume</a>
                </div>
                <br />
