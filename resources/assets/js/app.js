...
Vue.component('owner-request-any-captain', require('./components/owner/RequestAnyCaptain.vue'));
Vue.component('owner-book-any-captain-confirm', require('./components/owner/BookAnyCaptainConfirm.vue'));
Vue.component('owner-send-request-any', require('./components/owner/SendRequestAny.vue'));
...
Vue.component('cancellation', require('./components/Cancellation.vue'));
Vue.component('privacy', require('./components/Privacy.vue'));
...
Vue.directive('sup', function (el, binding) {
    ...
    var s = (Math.abs(parseInt(value/100))).toString();
    var len = s.length;
    var k = 0;
    for (var i = 0; i < len; i++) {
        k++;
