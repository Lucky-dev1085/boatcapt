<template>
    <section>
        <article class="article-page">
            <h2 class="article-title mb-3">Contact Captain</h2>
            ...
            <div class="captain-view">
                ...
                <div class="aside-right">
                    ...
                    <template v-if="tripInfo.powerBoats || tripInfo.sailBoats">
                        <p v-if="tripInfo.powerBoats && tripInfo.sailBoats">
                            <img :src="URL.base + '/public/images/boats-icon.png'"/> Power/Sailboats
                        </p>
                        <p v-else-if="tripInfo.powerBoats">
                            <img :src="URL.base + '/public/images/boats-icon.png'"/> Power Boats
                        </p>
                        <p v-else-if="tripInfo.sailBoats">
            ...
            <h3 class="article-title mt-5">{{ tripInfo.firstName }} {{ tripInfo.lastName }}</h3>
            <h4 class="article-subtitle font-italic">{{ tripInfo.city }}, {{ tripInfo.state }}</h4>
            <table class="table-pair-detail h4">
                <tbody>
                    <tr>
                        <th>Phone:</th>
                        <td>{{ tripInfo.captainPhone }}</td>
                    </tr>
                    <tr>
                        <th>Email:</th>
                        <td>{{ tripInfo.captainEmail }}</td>
                    </tr>
                </tbody>
            </table>
            <br/>
            ...
            <div class="text-center mb-4">
                <a href="#" class="btn btn-darkblue btn-size-360">Add to Calendar</a>
            </div>
        </article>
    </section>
</template>
