...
<?php $__env->startSection('content'); ?>
    ...
    <admin-captain-profile v-bind:message="<?php echo e(json_encode(['status' => 'failed', 'body' => $errors->all()])); ?>" v-bind:user-info="<?php echo e($userInfo); ?>" v-bind:user-name="<?php echo e($userName); ?>" v-bind:old-input="<?php echo e(json_encode(old())); ?>"></admin-captain-profile>
    <?php else: ?>
