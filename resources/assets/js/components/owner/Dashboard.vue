        ...
        <article class="article-page">
            <template v-if="bidCount == 0 && tripCount == 0">
                ...
                <h5 class="article-subtitle">
                    ...
                    <a :href="URL.base + '/owner-request-captain'" class="link-underline">Request a Captain</a>
                </h5>
                <br/>
                <br/>
                <div class="text-center">
                    <a :href="URL.base + '/owner-request-captain'" class="btn btn-darkblue btn-size-360">Request a Captain</a>
                </div>
                <br/>
            </template>
            <template v-else>
